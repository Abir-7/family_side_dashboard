...
} from "@/lib/redux/apis/activityApi";
...
export default function ActivityPage() {
  ...
  const [getAllActivities, { isFetching: isExporting }] =
    useLazyGetAllActivitiesQuery();
  ...
  return (
    <TooltipProvider>
      <div className="bg-white min-h-[calc(100vh-115px)]  rounded-2xl border border-gray-100 flex flex-col relative">
