...
export default function EventsPage() {
  ...
  const [getAllEvents, { isFetching: isExporting }] =
    useLazyGetAllEventsQuery();
  ...
  return (
    <TooltipProvider>
      <div className="bg-white rounded-2xl border border-gray-100 min-h-[calc(100vh-115px)]  flex flex-col relative">
