        ...
        <div className="px-4 pb-4 space-y-3">
          ...
          <div className="flex items-center gap-3 bg-white border border-gray-100 rounded-xl p-3 shadow-sm">
            ...
            <div>
              ...
              <Badge className="bg-orange-100 text-orange-500 hover:bg-orange-100 border-0 rounded-full text-[10px] px-2 py-0 font-medium">
                Father
              </Badge>
            </div>
          </div>
          ...
          <div className="bg-white border border-gray-100 rounded-xl p-3 shadow-sm space-y-2">
            ...
            <div className="flex items-center gap-2">
              <Progress
                value={91}
                className="h-2 flex-1 bg-gray-100 [&>div]:bg-green-400"
              />
          ...
          <div>
            ...
            <div className="flex items-center gap-3 bg-white border border-gray-100 rounded-xl p-3 shadow-sm">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-gray-400 mb-1">12/02/2009</p>
                <Badge className="bg-blue-100 text-blue-500 hover:bg-blue-100 border-0 rounded-full text-[10px] px-2 py-0 font-medium">
                  Male
                </Badge>
              </div>
